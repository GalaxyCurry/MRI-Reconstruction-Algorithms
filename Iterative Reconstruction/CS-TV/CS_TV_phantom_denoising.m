% This script demonstare a CS reconstruction from Randomly undersmapled phase encodes of a 2D GRE Phantom scan, 
% were the phantom data is noisy
% 从 2D GRE 水模扫描的随机欠采样相位编码中进行CS重建,其中水模数据是有噪声的。
